...
vi.mock('../../hooks/useRulesManagerViewModel', () => ({
  useRulesManagerViewModel: ({
    ...
    return {
      ...
      validationError: '',
      tabs: [
        { id: 'all' as const, label: 'All', count: 51 },
        { id: 'allowed' as const, label: 'Allowed', count: 50 },
        { id: 'blocked' as const, label: 'Blocked', count: 1 },
        { id: 'disabled' as const, label: 'Disabled', count: 0 },
      ],
