...
export function CreateGroupModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="New Group" className="max-w-md">
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-1">Name (slug)</label>
          <input
            type="text"
            placeholder="E.g. elementary-group"
            value={name}
          ...
          />
          <p className="text-xs text-slate-500 mt-1">Used as the group identifier (slug).</p>
          {error && (
