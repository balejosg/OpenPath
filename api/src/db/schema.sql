...
--> statement-breakpoint
DO $$ BEGIN
	ALTER TABLE "windows_offline_download_refs" ADD CONSTRAINT "windows_offline_download_refs_classroom_id_classrooms_id_fk" FOREIGN KEY ("classroom_id") REFERENCES "public"."classrooms"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
	WHEN duplicate_object THEN NULL;
END $$;
--> statement-breakpoint
